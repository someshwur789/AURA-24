...
The main goal of this project is to simplify the event management and registration process for our department symposium by providing a digital platform that is efficient, accessible, and easy to use.

---

<h3 style="font-size:20px;">📄 License</h3>

This project is developed for educational purposes and symposium use.
